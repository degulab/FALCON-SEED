...
echo --- ANTLR build AADLWalker tree grammar... ---
echo.

java -Xmx200M -cp ..\lib\antlr-3.0.1.jar;..\lib\antlr-2.7.7.jar;..\lib\stringtemplate-3.1b1.jar org.antlr.Tool -o walker -lib build AADLWalker.g

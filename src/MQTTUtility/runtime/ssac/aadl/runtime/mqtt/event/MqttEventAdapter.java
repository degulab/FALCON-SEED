 ...
 */
/*
 * @(#)MqttEventAdapter.java	0.3.0	2013/06/27
 *     - modified by Y.Ishizuka(PieCake.inc,)
 * @(#)MqttEventAdapter.java	0.2.0	2013/05/15
...
/**
 * MQTT クライアントで発生したイベントのアダプタ。
 * ハンドラのすべてのインタフェースで、なにも処理を行わない実装となる。
 * 
 ...
 * @author Hideki Tanuma (TOKYO INSTITUTE OF TECHNOLOGY)
 */
public class MqttEventAdapter implements MqttEventHandler
{
	//------------------------------------------------------------
	// Constants
	//------------------------------------------------------------

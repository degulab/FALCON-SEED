...
public class GenConversionRatio
{
	//------------------------------------------------------------
	// Constants
	//------------------------------------------------------------
	...
	static private String MONGO_COL_RESULT1 = "GenConversionRatioResult1";	// 国調労調変換比率の出力先とする、MongoDB コレクション名
	static private String MONGO_COL_RESULT2 = "GenConversionRatioResult2";	// 自営業主数（確報）推計値の出力先とする、MongoDB コレクション名
	...
	public static void main(String[] args) {
		...
		try {
			...
			// genConversionRatio
			System.out.println("@@@ Start 'GenConversionRatio' program...");

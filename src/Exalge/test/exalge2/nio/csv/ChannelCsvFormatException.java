 ...
 */
/*
 * @(#)ChannelCsvFormatException.java	0.980	2009/04/09
 ...
 * @since 0.980
 */
public class ChannelCsvFormatException extends IOException
{
	//------------------------------------------------------------
	// Constants
	//------------------------------------------------------------
	 ...
	 * 詳細情報を持たない新規例外を構築する。
	 */
	public ChannelCsvFormatException() {
		super();
	 ...
	 */
	public ChannelCsvFormatException(String message) {
		super(message);
		initialize(NO_LINE_NUMBER, NO_COLUMN_NUMBER);
	}
	 ...
	 */
	public ChannelCsvFormatException(int lineNo, int fieldNo) {
		super();
	 ...
	 * @param fieldNo	エラー発生箇所を示すフィールド番号
	 */
	public ChannelCsvFormatException(String message, int lineNo, int fieldNo) {
		super(message);
		initialize(lineNo, fieldNo);
	}

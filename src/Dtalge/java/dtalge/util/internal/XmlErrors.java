 ...
 */
/*
 * @(#)XmlErrors.java	0.20	2010/02/25
 *     - modified by Y.Ishizuka(PieCake.inc,)
 * @(#)XmlErrors.java	0.10	2008/08/25
...
public final class XmlErrors
{
	...
	static public final class Format {
		static public final String WARNING_PLUS_WRAPPED_MSG
			= "WARNING:  ''{0}''\n       :{1}";
		static public final String WARNING_MSG
			= "WARNING:  ''{0}''";
		static public final String FATAL_ERR_PLUS_WRAPPED_MSG
			= "FATAL ERROR:  ''{0}''\n           :{1}";
		static public final String FATAL_ERR_MSG
			= "FATAL ERROR:  ''{0}''";
		static public final String ERROR_PLUS_WRAPPED_MSG
			= "ERROR:  ''{0}''\n     :{1}";
		static public final String ERROR_MSG
			= "ERROR:  ''{0}''";
	}
	...
	/**
	 * 指定されたパターンでフォーマットされたメッセージを返す。
	 * このメソッドでは、パターンによるフォーマットに
	 * {@link java.text.MessageFormat#format(String, Object...)} メソッドを使用する。
	 * @param format	フォーマットのパターン
	 * @param args		パターンに適用する値
	 * @return	フォーマットされた文字列
	 * 
	 * @see java.text.MessageFormat#format(String, Object...)
	 * @since 0.20
	 */
	static public String formatMessage(String format, Object...args) {

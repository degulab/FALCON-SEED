 ...
 */
public class CsvFieldConditionOr extends AbCsvFieldConditionPair
{
	//------------------------------------------------------------
	// Constants
	//------------------------------------------------------------
	 ...
	 */
	public CsvFieldConditionOr(ICsvFieldCondition firstElement, ICsvFieldCondition secondElement)
	{
	...
	/**
	 * 指定された CSV レコードの内容が、このオブジェクトが保持するフィールド条件のいずれか一方を満たしているかどうかを判定する。

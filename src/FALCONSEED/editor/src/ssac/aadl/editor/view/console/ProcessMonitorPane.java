/*
 * @(#)ProcessMonitorPane.java	4.0.0	2021/08/27 : for Java11
...
public class ProcessMonitorPane extends AbstractMonitorPane
{
	...
	protected void updateTarget() {
		File execfile = (targetDocument==null ? null : targetDocument.getExecutableFile());
		if (execfile != null) {
			if (JarFileInfo.isFatJarFile(execfile)) {
				lblTarget.setText(execfile.getName() + JarFileInfo.FATJAR_SUFFIX_LABEL);
			} else {

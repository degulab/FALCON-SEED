 ...
 */
/*
 * @(#)AbSpreadSheetView.java	1.17	2011/02/02
 *     - modified by Y.Ishizuka(PieCake.inc,)
 * @(#)AbSpreadSheetView.java	1.16	2010/09/27
 *     - modified by Y.Ishizuka(PieCake.inc,)
 * @(#)AbSpreadSheetView.java	1.14	2009/12/13
 *     - modified by Y.Ishizuka(PieCake.inc,)
 * @(#)AbSpreadSheetView.java	1.10	2009/02/12
 *     - modified by Y.Ishizuka(PieCake.inc,) - bugfix
 * @(#)AbSpreadSheetView.java	1.10	2009/01/19
...
implements IEditorView
{
	...
	*/
	...
	protected void onTableSelectionChanged(ListSelectionEvent e) {
		EditorFrame frame = getFrame();
		if (frame != null) {
			frame.getMenuAction(EditorMenuResources.ID_EDIT_CUT).setEnabled(canCut());
			frame.getMenuAction(EditorMenuResources.ID_EDIT_COPY).setEnabled(canCopy());
			frame.getMenuAction(EditorMenuResources.ID_EDIT_DELETE).setEnabled(canCut());

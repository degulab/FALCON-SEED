/*
 * @(#)EditorMenuBar.java	4.0.0	2021/08/27 : for Java11
...
public class EditorMenuBar extends JMenuBar
{
	...
	private static final long serialVersionUID = 6085188228835497022L;
	...
	protected JMenu createBuildMenu() {
		...
		menu.addSeparator();
		//--- [compile-with-libs]
		menu.add(createDefaultEditorMenuItem(EditorMenuResources.ID_BUILD_COMPILE_FATJAR));
		//--- [compile-with-libs & run]
		menu.add(createDefaultEditorMenuItem(EditorMenuResources.ID_BUILD_COMPILE_FATJAR_RUN));
		//---
		menu.addSeparator();
		//--- [run as jar]

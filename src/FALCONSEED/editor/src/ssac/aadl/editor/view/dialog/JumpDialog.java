 ...
 */
/*
 * @(#)JumpDialog.java	1.00	2008/03/24
 *     - created by Y.Ishizuka(PieCake.inc,)
 * @(#)JumpDialog.java	1.10	2008/12/03
...
public class JumpDialog extends BasicDialog
{
	...
	public JumpDialog(Frame owner, int maxLines) {
		super(owner, EditorMessages.getInstance().JumpDlg_Title_Main, true);
		...
		String strDesc = EditorMessages.getInstance().JumpDlg_Title_Desc + "(1..." + this.maxLineNo + ")";
	...
	protected void setupMainPanel() {
		...
		// Label
		lblDesc = new JLabel(EditorMessages.getInstance().JumpDlg_Title_Desc);

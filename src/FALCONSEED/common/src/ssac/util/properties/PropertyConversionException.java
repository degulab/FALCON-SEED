 ...
 */
/*
 * @(#)PropertyConversionException.java	1.17	2010/11/19
 *     - created by Y.Ishizuka(PieCake.inc,)
 */
package ssac.util.properties;

/**
 * プロパティの値変換に失敗したときにスローされる例外。
 * 
...
public class PropertyConversionException extends PropertyException
{
	 ...
	 * 呼び出すことで初期化される。
	 */
	protected PropertyConversionException() {
		super();
	}
	 ...
	 */
	protected PropertyConversionException(String message) {
		super(message);
	}
	 ...
	 */
	protected PropertyConversionException(Throwable cause) {
		super(cause);
	}
	 ...
	 * 				<tt>null</tt> 値が許可されており、原因が存在しないか不明であることを示す。
	 */
	protected PropertyConversionException(String message, Throwable cause) {
		super(message, cause);
	}

 ...
 */
/*
 * @(#)CsvFileModel.java	2.0.0	2012/10/02
 *     - modified by Y.Ishizuka(PieCake.inc,)
 * @(#)CsvFileModel.java	1.10	2011/02/14
 *     - modified by Y.Ishizuka(PieCake.inc,)
 * @(#)CsvFileModel.java	1.00	2010/12/20
...
public class CsvFileModel extends SpreadSheetModel implements IEditorTableDocument
{
	...
	//static public final int	MAX_VISIBLE_ROWS	= 100;
	...
	public CsvFileModel(final CsvFileComponentManager manager, CsvRecordCursor cursor)
	{
		...
		this._lastEncoding = JCharsetComboBox.getAvailableCharsetName(cursor.getFileData().getEncoding());

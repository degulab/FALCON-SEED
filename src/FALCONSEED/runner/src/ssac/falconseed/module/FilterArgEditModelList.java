 ...
 */
/*
 * @(#)FilterArgEditModelList.java	3.2.0	2015/06/10
 ...
 * @since 3.2.0
 */
public class FilterArgEditModelList extends ArrayList<FilterArgEditModel>
{
	//------------------------------------------------------------
	// Constants
	//------------------------------------------------------------
	...
	public FilterArgEditModelList() {
		super();
	}

	public FilterArgEditModelList(int initialCapacity) {
		super(initialCapacity);
	}

	public FilterArgEditModelList(Collection<? extends FilterArgEditModel> c) {
		super(c.size());
		int argno = 1;
	...
	@Override
	public FilterArgEditModelList clone() {
		// deep-copy
		FilterArgEditModelList newlist = (FilterArgEditModelList)super.clone();

/*
 * @(#)ActiveViewManager.java	1.0.0	2022/12/15
 ...
 * @version 1.0.0
 */
public class DtContainerContentActiveViewManager
{
	//------------------------------------------------------------
	// Constants
	//------------------------------------------------------------
	 ...
	 * 標準のコンストラクタ
	 */
	public DtContainerContentActiveViewManager() {
	...
	public void addActiveViewChangeListener(DtContainerContentActiveViewChangeListener l) {
		listenerList.add(DtContainerContentActiveViewChangeListener.class, l);
	}
	
	public void removeActiveViewChangeListener(DtContainerContentActiveViewChangeListener l) {
		listenerList.remove(DtContainerContentActiveViewChangeListener.class, l);
	}
	
	public DtContainerContentActiveViewChangeListener[] getActiveViewChangeListeners() {
		return (DtContainerContentActiveViewChangeListener[])listenerList.getListeners(DtContainerContentActiveViewChangeListener.class);
	}
	...
	protected void fireActiveViewChanged(JComponent activated, JComponent deactivated) {
		...
		DtContainerContentActiveViewChangeEvent e = null;
		for (int i = listeners.length-2; i>=0; i-=2) {
			if (listeners[i]==DtContainerContentActiveViewChangeListener.class) {
				if (e == null) {
					e = new DtContainerContentActiveViewChangeEvent(this, activated, deactivated);
				}
				((DtContainerContentActiveViewChangeListener)listeners[i+1]).activeViewChanged(e);
			}
		}
	}
	 ...
	 * @version 1.0.0
	 */
	static public class DtContainerContentActiveViewChangeEvent extends EventObject
	{
		...
		public DtContainerContentActiveViewChangeEvent(Object source, JComponent activated, JComponent deactivated) {
			super(source);
			_cActivated = activated;
			_cDeactivated = deactivated;
		}
		
		public DtContainerContentActiveViewManager getSourceManager() {
			return (DtContainerContentActiveViewManager)getSource();
		}
	 ...
	 * @version 1.0.0
	 */
	static public interface DtContainerContentActiveViewChangeListener extends EventListener
	{

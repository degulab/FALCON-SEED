/*
 * @(#)IDtContainerEditController.java	1.0.0	2022/12/21
...
/**
 * データコンテナの編集用ドキュメントタイプを保持するコントローラーのインターフェース。
 * 
 * @version 1.0.0
 */
public interface IDtContainerEditController extends IMenuActionHandler
{
	//------------------------------------------------------------
	// Constants
	//------------------------------------------------------------
	 ...
	 */
	public IDtContainerEditView newDocument(String templateText);
	/**
	 ...
	 */
	public IDtContainerEditView newDocument(File targetFile, String templateText) throws IOException;
	/**
	 ...
	 */
	public IDtContainerEditView openDocument(Component parentComponent, File targetFile) throws IOException;
	/**
	 ...
	 */
	public IDtContainerEditView onNewComponent(Component parentComponent);
	/**
	 ...
	 * @return	ドキュメントが関連付けられたビュー
	 */
	//public IDtContainerEditView onOpenComponent(Component parentComponent) throws IOException;
	/**
